...
<body>
<center>
<p style="padding: 2px 0px 2px 0px; font-size: 20px" class="bg-primary">Ingreso de factura Electrónica de venta de la empresa <b><?php echo" $nombreEmpresa - $Rutempre" ?></b></p></center>
