...
$insert= mysqli_query($mysqli,"INSERT INTO Usuarios VALUES (null,'$usr','$pass',1,'$rutE')");
...
<div style="height: 150px" class="col-xs-12 col-sm-12 col-md-12 col-lg-12"></div>
	<h2 style="color: #5cb85c">Usuario <?php echo $usr ?> registrado correctamente en la empresa <?php echo $nombreE ?></h2>
...
<?php
  ...
  <a href="opciones.php?rut='.$rutE.'" class="alert-link">El nombre de usuario ya está utilizado --> presiona aquí para volver</a>
</div></center>';
}
