...
<body>
<center>
<p style="padding: 2px 0px 2px 0px; font-size: 20px" class="bg-primary">Ingreso de boleta manual de venta<b><?php echo" $nombreEmpresa - $Rutempre" ?></b></p></center>
</center>
...
<p><div class="col-md-4 col-lg-4 "><label>Tipo</label><input class="form-control" id="disabledInput" type="text" placeholder="Boleta manual" readonly></div></p>
