...
<body>
<center>
<p style="padding: 2px 0px 2px 0px; font-size: 20px" class="bg-primary">Ingreso de factura manual de compra de la empresa <b><?php echo" $nombreEmpresa - $Rutempre" ?></b></p></center>
...
<p><div class="col-md-4 col-lg-4 "><label>Tipo</label><input class="form-control" id="disabledInput" value="Factura Manual" type="text" placeholder="Tipo" readonly></div></p>
...
<p><div class="col-md-6 col-lg-6  "><label>Nombre empresa a la que se compra</label><input class="form-control" name="cc" value="<?php echo $Razon ?>"  readonly></div></div>
...
<p><div class="col-md-4 col-lg-4 "><label>Tipo</label><input class="form-control" id="disabledInput" type="text" placeholder="Factura manual" readonly></div></p>
