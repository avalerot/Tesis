...
<body>
<center>
<p style="padding: 2px 0px 2px 0px; font-size: 20px" class="bg-primary">Ingreso de NOTA DE CREDITO ELECTRONICA de compra de la empresa <b><?php echo" $nombreEmpresa - $Rutempre" ?></b></p></center>
...
<p><div class="col-md-4 col-lg-4 "><label>Tipo</label><input class="form-control" id="disabledInput" value="nota de crédito" type="text" placeholder="Tipo" readonly></div></p>
...
<p><div class="col-md-4 col-lg-4 "><label>Tipo</label><input class="form-control" id="disabledInput" type="text" placeholder="nota de crédito" readonly></div></p>
