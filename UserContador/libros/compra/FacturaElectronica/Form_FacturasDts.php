...
<body>
<center>
<p style="padding: 2px 0px 2px 0px; font-size: 20px" class="bg-primary">Ingreso de factura Electrónica de compra de la empresa <b><?php echo" $nombreEmpresa - $Rutempre" ?></b></p></center>
...
<p><div class="col-md-4 col-lg-4 "><label>Tipo</label><input class="form-control" id="disabledInput" value="Factura electrónica" type="text" placeholder="Tipo" readonly></div></p>
...
<p><div class="col-md-4 col-lg-4 "><label>Tipo</label><input class="form-control" id="disabledInput" type="text" placeholder="Factura electrónica" readonly></div></p>
