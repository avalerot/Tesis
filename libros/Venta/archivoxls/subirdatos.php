...
$VerificadorEmpre = mysqli_fetch_array($empresa, MYSQLI_NUM);
             ...
             if($ruut==$accionfiladatos){
				$RutEmpresa=$objCelda['F'];
				$nombreEmpresa=$objCelda['G'];
				$RutRazon=$objCelda['N'];
				$NombreRazon=$objCelda['O'];
...
$subirfacventa= "INSERT INTO facturaventa VALUES (null, '$numeroFac','$RutRazon','$Rutempre','$mestrabajo','$anotrabajo','$auxiliar','$idCc','$fechaEmision','$neto','$exento','$iva','$total','$TotalEspyRet',33)";
...
$subirsecuefac= "INSERT INTO secuenciafactventa VALUES (null, '$numeroFac','$idiva','$TotalSec','$TotalIVA','$abono','$NetoSec','$espdisel','$espiscos','$esbebidas','$esvinos','$retcarne','$retharina','$Rutempre','$NumSec',33)";
