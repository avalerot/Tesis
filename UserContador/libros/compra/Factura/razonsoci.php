...
<label>Nombre empresa a la que se compra</label><input minlength="6"  class="form-control" name="razonsoc"  autocomplete="off" onkeyup="this.value=this.value.toUpperCase()"  type="text" required  >
