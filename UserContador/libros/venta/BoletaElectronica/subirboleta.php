...
$hast = $mysqli->query("SELECT desde, hasta FROM boleta where rutEmpre='$Rutempre' and tipoDoc=3 ");
...
$subirbolventa= "INSERT INTO boleta VALUES (null, '$Rutempre','$idCc','$auxiliar','$desde','$hasta','$neto','$totaliva','$total','$fecha',3,'$mestrabajo','$anotrabajo')";
if ($mysqli->query($subirbolventa)) { 

header("Location: form_boleta.php?Rutempre=$Rutempre&anotrabajo=$anotrabajo&mestrabajo=$mestrabajo");   
