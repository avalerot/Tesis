...
$subirfacventa= "INSERT INTO FacturaVenta VALUES (null, '$numero','$rutfac','$Rutempre','$mestrabajo','$anotrabajo','$auxiliar','$idCc','$fecha','$totalneto',0,'$totaliva','$tottal','$totalespe',33)";
if ($mysqli->query($subirfacventa)) {
	     foreach ($arraySecuenF as $key => list($total,$ivapes,$abono,$neto,$espeSec,$espdisel,$espiscos,$esvinos,$esbebidas,$retcarne,$retharina))
	      {
	      	$subirsecuefac= "INSERT INTO SecuenciaFactVenta VALUES (null, '$numero','$idiva','$total','$ivapes','$abono','$neto','$espdisel','$espiscos','$esbebidas','$esvinos','$retcarne','$retharina','$Rutempre','$key',33)";
