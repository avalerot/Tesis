...
$subirfacventa= "INSERT INTO facturacompra VALUES (null, '$numero','$rutfac','$Rutempre','$mestrabajo','$anotrabajo','$auxiliar','$idCc','$fecha','$totalneto',0,'$totaliva','$tottal','$totalespe',55)";
if ($mysqli->query($subirfacventa)) {
	     foreach ($arraySecuenF as $key => list($total,$ivapes,$abono,$neto,$espeSec,$espdisel,$espiscos,$esvinos,$esbebidas,$retcarne,$retharina))
	      {
	      	$subirsecuefac= "INSERT INTO secuenciafactcompra VALUES (null, '$numero','$idiva','$total','$ivapes','$abono','$neto','$espdisel','$espiscos','$esbebidas','$esvinos','$retcarne','$retharina','$Rutempre','$key',55)";
...
?>
	<h4>
	<center>
<div style="margin: 20px 0px 0px 0px " class="alert alert-warning" role="alert"> <i>Nº <?php echo$numero ?></i> ESTA FUERA DE PLAZO  <i>  -  <?php echo$Rutempre ?></i> </div></center></h4>
	<?php
