...
<body>
<center>
<p style="padding: 2px 0px 2px 0px; font-size: 20px" class="bg-primary">Ingreso de factura exenta de compra de la empresa <b><?php echo" $nombreEmpresa - $Rutempre" ?></b></p></center>
...
if(isset($_POST['fecha']) AND isset($_POST['numero'])AND  isset($_POST['Rut']) AND isset($_POST['cd']) AND isset($_POST['aux']) AND isset($_POST['cc']) AND isset($_POST['razonsoc']) AND isset($_POST['totalespe']) and isset($_POST['exen'])){
...
<p><div class="col-md-4 col-lg-4 "><label>Tipo</label><input class="form-control" id="disabledInput" value="Factura exenta" type="text" placeholder="Tipo" readonly></div></p>
...
<p><div class="col-md-2 col-lg-2  "><label>Rut</label><input minlength="6"  class="form-control" name="Rutfact" value="<?php echo $rut ?>" type="text" placeholder="<?php echo $rut ?>" readonly></div></p>
...
<p><div class="col-md-6 col-lg-6  "><label>Nombre empresa a la que se compra</label><input class="form-control" name="cc" value="<?php echo $Razon ?>"  readonly></div>
 <p><div class="col-md-3 col-lg-3  "><label>exento totales</label><input placeholder="$" class="form-control" name="exen" " type="text"   value="<?php echo $exen ?>"  readonly></div></p>
</div>
...
<p><div class="col-md-4 col-lg-4 "><label>Tipo</label><input class="form-control" id="disabledInput" type="text" placeholder="Factura exenta" readonly></div></p>
...
<div class="hidden-xs hidden-sm col-md-12 col-lg-12 " style="margin: 3px"></div>
<p><div class="col-md-2 col-lg-2  "><label>Rut </label><input onchange="load(this.value)" onkeypress='return solonumeros(event)' class="form-control"  onblur="getDV(this.value)" name="Rut" type="text" placeholder="rut" ></div></p>
...
<p><div class="col-md-3 col-lg-3  "><label>exento total</label><input placeholder="$" onkeypress='return solonumeros(event)' class="form-control" name="exen" " type="text" required></div></p>
...
<div class="hidden-md hidden-lg col-sm-5 col-xs-5 "></div>
        <div class="col-md-3 col-lg-3 col-sm-7 col-xs-7 "><a href="../../../UserContador/opciones.php?rut=<?php echo$Rutempre ?>" class="btn btn-primary">ir a opciones</a></div>
</form>
</div>
</div>
<div class="col-md-2 col-xs-1 col-lg-2 col-sm-1" ></div>
