...
?>
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <center>  <h4 class="modal-title">Agregar un usuario a la empresa <?php echo $nombreE; ?> <h2>  <?php echo $rutE; ?></h2> </h4></center> 
      </div>
...
<form method="post" action="Agregarusr.php">
	<p><label>Nombre de usuario</label><input class="form-control" type="text" name="usr"></p>
  <p><label>Contraseña</label><input placeholder="Momentanea" class="form-control" type="text" name="pass"></p>
  ...
  <div  class="modal-footer" >
        ...
        <button style="margin: 15px 0px 0px 0px;" type="submit" class="btn btn-success">Agregar usuario</button>
      </div>
</form>
</center>
</div>
