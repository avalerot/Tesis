...
$insert= mysqli_query($mysqli,"INSERT INTO centrocostos  VALUES (null,'$cc','$rutE',1)");
...
<div style="height: 150px" class="col-xs-12 col-sm-12 col-md-12 col-lg-12"></div>
	<h2 style="color: #5cb85c">Centro de costos <?php echo $cc ?> registrado correctamente en la empresa <?php echo $nombreE ?></h2>
...
<?php
  ...
  <a href="opciones.php?rut='.$rutE.'" class="alert-link">centro de costos no registrado --> presiona aquí para volver</a>
</div></center>';
}
