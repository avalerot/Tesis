...
$empresa = $mysqli->query("SELECT E.NombreEmpresa,E.Rut,E.VerificadorEmpresa, C.qr, E.mail FROM empresa E LEFT JOIN codigo C ON C.rutEmpresa=E.rut where E.Estado='1' order by E.NombreEmpresa asc ");
